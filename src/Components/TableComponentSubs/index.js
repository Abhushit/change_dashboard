...
export default function TableComponentSubs(props) {
                  ...
                  {props.columns.map((col, index) =>
                    (col.id === "image") ? (
                      ...
                      <StyledTableCell align="left" sx={{ width:"500px", }}>
                        {(row[col.id].substring(0, 100) + (row[col.id].length > 100 ? "..." : ' '))}
                      </StyledTableCell>
                      :
                      (col.id === "status") ?
                      <StyledTableCell align="right">
                        <span
                            style={{
                              ...
                              padding:"6px 10px",
                              fontWeight:'600',
                              color:(row[col.id] === "Paid" || row[col.id] === "Sent") ? "green": row[col.id] === "Not Paid" ? "red" : "#d9d921",
                              background: (row[col.id] === "Paid" || row[col.id] === "Sent") ? "#c4ffc4" : row[col.id] === "Not Paid" ? "#ffdddd" : "#fff6d7",
                            }}
                          >
                            {row[col.id]}
                          </span>
